...
app.get('/event', function(req,res){
  connection.query("select event.id, event.titre, event.description, count(preference.datepref) as nbrvote from event, preference where event.id = preference.idevent group by event.id", function(error,rows,field){
    if(!!error){
      console.log('Error in the query');
    }else{
      console.log('Successful query');
